...
<!-- BEGIN: Header-->
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light bg-customize-header">
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-md-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="#"><i class="ft-menu font-large-1"></i></a></li>
                <li class="nav-item"><a class="navbar-brand" href="#"><img class="brand-logo" alt="modern admin logo" src="Management/images/logo/logo.png">
                        <h3 class="brand-text">اسم سایت</h3></a></li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="far fa-bell" style="font-size: 21px;"></i></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="">
                                <h6 class="dropdown-header dropdown-menu-header m-0 mb-1"><span class="grey darken-2">پیام ها</span></h6>
                            </li>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="avatar avatar-online"><img src="Management/images/portrait/small/avatar-s-9.png" alt="avatar"></span>
                        </a>
                  ...
                  <span class="dropdown-item center" style="display: flex;">
                    ...
                    <a href="#">افزودن عکس</a>
                            ...
                            <a class="dropdown-item" href="#">
                                <i class="fa fa-inbox"></i> صندوق ورودی من
                            </a>
                            <a class="dropdown-item" href="#">
                                <i class="fa fa-tasks"></i> وظیفه
                            </a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="login-with-bg-image.html"><i class="fa fa-close"></i> خروج</a>
                        </div>
                    </li>
                </ul>
            </div>
