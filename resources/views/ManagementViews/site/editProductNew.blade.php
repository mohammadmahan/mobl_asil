                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <label>عنوان محصول</label>
                                                                <input type="text" class="form-control" name="title"
                                                                    value="{{old('name',isset($productNewItem) ? $productNewItem -> title: '')}}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-6 mb-2">
                                                            <label>کد محصول</label>
                                                                <input type="text" class="form-control" name="number_product"
                                                                    value="{{old('name',isset($productNewItem) ? $productNewItem -> number_product: '')}}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-6 mb-2">
                                                            <label>قیمت محصول</label>
                                                                <input type="text" class="form-control" name="cost"
                                                                    value="{{old('name',isset($productNewItem) ? $productNewItem -> cost: '')}}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-6 mb-2">
                                                            <label>توضیحات</label>
                                                                <input type="text" class="form-control" name="Description"
                                                                    value="{{old('name',isset($productNewItem) ? $productNewItem -> Description: '')}}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-md-6 mb-2">
                                                    ...
                                                    <div class="col-md-6 tahlil-img">
                                                        <img src="{{old('name',isset($productNewItem) ? $productNewItem -> image: '')}}"
